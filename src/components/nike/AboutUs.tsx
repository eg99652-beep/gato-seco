    ...
    <section className="w-full px-6 py-20 md:py-28" style={{ background: "#f7f5f0" }}>
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div style={{ width: "36px", height: "2px", background: "#e8e4db", borderRadius: "2px", marginBottom: "1.8rem" }} />
        ...
        <div className="w-full aspect-[4/5] rounded-2xl overflow-hidden relative flex items-center justify-center" style={{ background: "#e8e4db" }}>
